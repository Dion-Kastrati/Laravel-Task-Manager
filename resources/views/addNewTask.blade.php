        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="/addNewTask" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <textarea name="desc" id="desc" class="pt-2 pb-2 pr-2 pl-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"></textarea>
                    </div>
                </div>
                <div>
                    ...
                    <div class="mt-2 flex justify-between">
                        <div>
                            ...
                            <input type="radio" name="priority" id="rad_1" value="Larte">
                        </div>
                        <div>
                            <label for="rad_1">Mesem</label>
                            <input type="radio" name="priority" id="rad_2" value="Mesem">
                        </div>
                        <div>
                            <label for="rad_1">Ulet</label>
                            <input type="radio" name="priority" id="rad_3" value="Ulet">
                        </div>
                    </div>
                </div>
                <div>
